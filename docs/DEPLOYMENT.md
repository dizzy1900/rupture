...
| `infra/jobs/*.yaml` + `schema.json` + `README.md` | nine portable job manifests with `aws:` annotations, a core-hour estimate and a stated basis on each, validated in the unit suite |
