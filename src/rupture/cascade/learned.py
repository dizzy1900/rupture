...
registry entry that stays absent until someone fills it. ADR-0036 records the decision.
...
the weights and their licence together with the code, and ADR-0036 is superseded by the ADR that
adopts it.
"""
...
STATUS = (
    ...
    "model. See ADR-0036 and docs/CASCADE.md section 9."
)
